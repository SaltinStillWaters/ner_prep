...
concat_jsonl_data('data/raw_jsonl', 'data/combined_raw.jsonl')
...
stage_1.save('processed_data/stg_1.jsonl', stg_1)
...
stage_2.save('processed_data/stg_2.pkl', stg_2)
...
stage_3.save('processed_data/stg_3', stg_3)
