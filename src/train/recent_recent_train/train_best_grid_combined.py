...
best_args = TrainingArguments(
    output_dir='follow-up/post_grid_models/combined_grid_best',
    ...
    logging_dir="follow-up/runs_combined_grid_best",
    logging_steps=500,
...
best_trainer.train()
best_trainer.save_model("follow-up/combined_grid_best")