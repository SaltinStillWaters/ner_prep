...
best_args = TrainingArguments(
    output_dir='training_results/post_grid_models/best_grid_augmented',
    learning_rate=1.30995E-05,
    ...
    logging_dir="training_results/post_grid_runs/best_grid_augmented",
    logging_steps=500,
...
best_trainer.train()
best_trainer.save_model("training_results/final_models/best_grid_augmented")