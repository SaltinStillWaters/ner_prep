...
args = TrainingArguments(
    ...
    eval_steps=250,  # More frequent eval to monitor performance closely
    save_strategy='steps',
    save_steps=250,
    logging_dir='runs_quality',
    logging_steps=100,
    learning_rate=1e-5,  # Lower learning rate for fine-grained updates
    num_train_epochs=8,  # More epochs to allow model to learn patterns
    per_device_train_batch_size=16,
    per_device_eval_batch_size=16,
    gradient_accumulation_steps=2,  # Helps if you need effective batch size of 32
    weight_decay=0.01,
    save_total_limit=2,
